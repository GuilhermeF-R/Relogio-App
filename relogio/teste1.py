...
class JanelaMetas(ScreenManager):
    pass

"""class JanelaCONFIGMetas(ScreenManager):
    pass

class JanelaADDMetas(ScreenManager):
    pass
    
class JanelaALERTMetas(ScreenManager):
    pass"""

class JanelaMotivação(ScreenManager):
    pass

"""class JanelaCONFIGMotivação(ScreenManager):
    pass

class JanelaADDMotivação(ScreenManager):
    pass

class JanelaMAISMotivação(ScreenManager):
    pass"""

class JanelaCalendario(ScreenManager):
    pass
